...
## Key Paths
- `src/features/tax-calculator/components/TaxInputForm.jsx` — Box 3 input modal and tax partner toggle
- `src/features/tax-calculator/components/Box1InputForm.jsx` — Box 1 salary input form
- `src/features/tax-calculator/components/TaxResultPanel.jsx` — Box 3 results and breakdown
